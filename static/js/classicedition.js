...
square[1] = new Square("Sorting");
square[2] = new Square("Searching");
square[3] = new Square("Primality Testing");
square[4] = new Square("Linear Diophantine Equation");
...
square[5] = new Square("Sieve of Eratosthenes");
square[7] = new Square("Fibonacci");
square[8] = new Square("Factorization");
square[9] = new Square("Euler Totient Function");
square[10] = new Square("Inverse Modulo Function");
square[11] = new Square("Polynomial Multiplication");
...
square[13] = new Square("String matching");
square[14] = new Square("Prefix Function");
square[15] = new Square("Binomial Function");
square[16] = new Square("Inclusion Exclusion Problem");
square[17] = new Square("Finding Max Min interval");
...
square[19] = new Square("Shortest Path");
square[20] = new Square("All Points Shortest Path");
square[21] = new Square("Minimum Spanning Tree");
square[22] = new Square("Lowest Common Ancestor");
square[23] = new Square("Bipartite Graph Checking");
